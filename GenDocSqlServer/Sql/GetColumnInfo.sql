...
SELECT 
    CAST(clmns.name AS VARCHAR(35)) as ColumnName,
    ...
    CAST(CAST(clmns.precision AS INT) AS VARCHAR(20)) AS NumeriPrecision,
    ...
    isnull(CAST(cnstr.definition AS VARCHAR(20)),'') AS DefaultValue
